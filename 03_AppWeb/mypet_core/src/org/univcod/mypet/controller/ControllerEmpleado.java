...
public class ControllerEmpleado {
    ...
    public int insert(Empleado em) throws Exception {
        ...
        cstmt.setString(12, em.getPersona().getTel2());
        ...
        em.getPersona().setId(cstmt.getInt(15));

        em.setId(cstmt.getInt(16));
    ...
    public void update(Empleado em) throws Exception {
        ...
        cstmt.setString(13, em.getPersona().getTel2());

        cstmt.setString(14, em.getCorreo());

        cstmt.setString(15, em.getContrasenia());
